...
export default function WaliKelasLayout({ children }: { children: React.ReactNode }) {
	...
	// PERUBAHAN DI SINI: Path mengarah ke /wali-kelas
	const menuItems = [
		{ name: "Dashboard", icon: LayoutDashboard, path: "/wali-kelas/dashboard" },
		{ name: "Literasi", icon: BookOpen, path: "/wali-kelas/literasi" },
		{ name: "Numerasi", icon: Calculator, path: "/wali-kelas/numerasi" },
		{ name: "Riwayat Lino", icon: History, path: "/wali-kelas/riwayat" },
	];
