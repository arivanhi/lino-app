...
import { ArrowLeft, Download, Eye, X, FileText, Calendar, User, BookOpen, Calculator, BarChart2, Info } from "lucide-react";
...
type NumStudent = {
	...
	numHistory: { judul: string; nilai: number | null; soalPdf: string | null; jawabanPdf: string | null }[];
									...
									<tr key={s.siswaId} className="hover:bg-slate-50">
										...
										<td className="py-3 px-4 text-center">
											<button
												...
												className="text-xs font-bold text-amber-600 hover:text-amber-800 bg-amber-50 px-3 py-1.5 rounded-lg transition-colors"
											>
												Lihat Tugas
											</button>
										</td>
