...
type ClassData = { id: string; nama: string; literasi: number; numerasi: number };
...
export default function RiwayatClientUI({
	...
	return (
		<div className="p-6 lg:p-8 max-w-7xl mx-auto space-y-6">
			...
			{/* --- MODAL DOWNLOAD PERBAIKAN WARNA TEKS --- */}
			{isModalOpen && (
			...
			{/* --- HIDDEN PDF TEMPLATE (BULK) - Menggunakan Absolute Position --- */}
			<div className="absolute -left-[9999px] top-0">
				<div id="pdf-bulk-report" style={{ width: "210mm", backgroundColor: "white", color: "black" }}>
					...
					>
						...
						<h2 style={{ fontSize: "24px", fontWeight: "bold", color: "#0f172a" }}>LITERASI & NUMERASI</h2>
					...
					<div style={{ padding: "15mm 20mm", pageBreakBefore: "always" }}>
						...
						<table style={{ width: "100%", borderCollapse: "collapse", marginTop: "16px", fontSize: "12px" }}>
							<thead>
								<tr style={{ backgroundColor: "#f1f5f9" }}>
									...
									<th style={{ border: "1px solid #cbd5e1", padding: "8px", textAlign: "center", width: "30%" }}>
										Grafik Numerasi
									</th>
								</tr>
							</thead>
							<tbody>
								{filteredDataPdf.map((c) => (
									<tr key={c.id}>
										...
										<td style={{ border: "1px solid #cbd5e1", padding: "8px", textAlign: "center" }}>{c.literasi}%</td>
										<td style={{ border: "1px solid #cbd5e1", padding: "8px", textAlign: "center" }}>{c.numerasi}</td>
										<td style={{ border: "1px solid #cbd5e1", padding: "8px", verticalAlign: "middle" }}>
											<div
												style={{
													width: "100%",
											...
											>
												<div
													style={{
														width: `${c.numerasi}%`,
														backgroundColor: c.numerasi >= 70 ? "#0d9488" : "#e11d48",
														height: "100%",
													}}
												></div>
											</div>
						...
						<p style={{ fontSize: "10px", color: "#64748b", marginTop: "12px" }}>
							* Laporan ini di-generate secara otomatis dari Sistem E-Journal Lino.
						</p>
					</div>
				</div>
			</div>
