...
export default function PimpinanLayout({ children }: { children: React.ReactNode }) {
	...
	// PERUBAHAN DI SINI: Path mengarah ke /pimpinan
	const menuItems = [
		{ name: "Dashboard", icon: LayoutDashboard, path: "/pimpinan/dashboard" },
		{ name: "Literasi", icon: BookOpen, path: "/pimpinan/literasi" },
		{ name: "Numerasi", icon: Calculator, path: "/pimpinan/numerasi" },
		{ name: "Riwayat Lino", icon: History, path: "/pimpinan/riwayat" },
	];
